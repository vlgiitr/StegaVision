...
class Encoder(nn.Module):
    def __init__(self):
        ...
        self.spatial_then_channel_attention1 = CBAM_SpatialThenChannel(gate_channels=65)
        self.spatial_then_channel_attention2 = CBAM_SpatialThenChannel(gate_channels=65)
        self.spatial_then_channel_attention3 = CBAM_SpatialThenChannel(gate_channels=65)
        self.spatial_then_channel_attention4 = CBAM_SpatialThenChannel(gate_channels=65)
        self.spatial_then_channel_attention5 = CBAM_SpatialThenChannel(gate_channels=65)
        self.spatial_then_channel_attention6 = CBAM_SpatialThenChannel(gate_channels=65)
        self.spatial_then_channel_attention7 = CBAM_SpatialThenChannel(gate_channels=65)
    ...
    def forward(self, input_S, input_C):
        ...
        x4 = self.spatial_then_channel_attention1(x4)
        ...
        # Apply channel attention
        x4 = self.spatial_then_channel_attention2(x4)
        ...
        # Apply channel attention
        x4 = self.spatial_then_channel_attention3(x4)
        ...
        # Apply channel attention
        x4 = self.spatial_then_channel_attention4(x4)
        ...
        # Apply channel attention
        x4 = self.spatial_then_channel_attention5(x4)
        ...
        # Apply channel attention
        x4 = self.spatial_then_channel_attention6(x4)
        ...
        # Apply channel attention
        x4 = self.spatial_then_channel_attention7(x4)
