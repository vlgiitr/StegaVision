...
class Encoder(nn.Module):
    def __init__(self):
        ...
        self.channel_then_spatial_attention1 = CBAM_ChannelThenSpatial(gate_channels=65)
        self.channel_then_spatial_attention2 = CBAM_ChannelThenSpatial(gate_channels=65)
        self.channel_then_spatial_attention3 = CBAM_ChannelThenSpatial(gate_channels=65)
        self.channel_then_spatial_attention4 = CBAM_ChannelThenSpatial(gate_channels=65)
        self.channel_then_spatial_attention5 = CBAM_ChannelThenSpatial(gate_channels=65)
        self.channel_then_spatial_attention6 = CBAM_ChannelThenSpatial(gate_channels=65)
        self.channel_then_spatial_attention7 = CBAM_ChannelThenSpatial(gate_channels=65)
    ...
    def forward(self, input_S, input_C):
        ...
        x4 = self.channel_then_spatial_attention1(x4)
        ...
        # Apply channel attention
        x4 = self.channel_then_spatial_attention2(x4)
        ...
        # Apply channel attention
        x4 = self.channel_then_spatial_attention3(x4)
        ...
        # Apply channel attention
        x4 = self.channel_then_spatial_attention4(x4)
        ...
        # Apply channel attention
        x4 = self.channel_then_spatial_attention5(x4)
        ...
        # Apply channel attention
        x4 = self.channel_then_spatial_attention6(x4)
        ...
        # Apply channel attention
        x4 = self.channel_then_spatial_attention7(x4)
