...
class CBAM_SpatialOnly(nn.Module):
    def __init__(self, gate_channels, kernel_size=7):
        super(CBAM_SpatialOnly, self).__init__()
...
class Encoder(nn.Module):
    def __init__(self):
        ...
        self.spatial_attention1 = CBAM_SpatialOnly(gate_channels=65)
        self.spatial_attention2 = CBAM_SpatialOnly(gate_channels=65)
        self.spatial_attention3 = CBAM_SpatialOnly(gate_channels=65)
        self.spatial_attention4 = CBAM_SpatialOnly(gate_channels=65)
        self.spatial_attention5 = CBAM_SpatialOnly(gate_channels=65)
        self.spatial_attention6 = CBAM_SpatialOnly(gate_channels=65)
        self.spatial_attention7 = CBAM_SpatialOnly(gate_channels=65)
